...
public class Search {
	...
	{			
		...
		if (tempRes1.length == 0) return null;
	...
	{		
		...
		if (listA == null || listB == null) return null;
		ArrayList<Integer> res = 
				new ArrayList<Integer>(Math.min(listA.size(), listB.length));
		// find the commons IDs in the two lists
		int a = 0, b = 0;
